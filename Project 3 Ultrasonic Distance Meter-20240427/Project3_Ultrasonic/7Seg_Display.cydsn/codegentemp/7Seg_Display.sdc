...
# Date: Wed, 22 May 2024 07:37:43 GMT
#set_units -time ns
create_clock -name {Transmitter_Clk(routed)} -period 25000 -waveform {0 12500} [list [get_pins {ClockBlock/dclk_3}]]
create_clock -name {Clock_1(routed)} -period 1000000 -waveform {0 500000} [list [get_pins {ClockBlock/dclk_4}]]
...
create_generated_clock -name {Clock_2} -source [get_pins {ClockBlock/clk_sync}] -edges {1 241 481} [list [get_pins {ClockBlock/dclk_glb_1}]]
...
create_generated_clock -name {Transmitter_Clk} -source [get_pins {ClockBlock/clk_sync}] -edges {1 601 1201} [list [get_pins {ClockBlock/dclk_glb_3}]]
