...
`ifdef WARP
`define CY_BLK_DIR "D:\Monash_Apps\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0"
...
`ifdef WARP
`define CY_BLK_DIR "D:\Monash_Apps\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_vref_v1_70"
...
module top ;
	...
	wire [0:0] tmpIO_0__Dis_A_net;
	wire [0:0] tmpINTERRUPT_0__Dis_A_net;
	electrical [0:0] tmpSIOVREF__Dis_A_net;
	...
	assign tmpOE__Dis_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_B_net;
	wire [0:0] tmpFB_0__Dis_B_net;
	wire [0:0] tmpIO_0__Dis_B_net;
	wire [0:0] tmpINTERRUPT_0__Dis_B_net;
	electrical [0:0] tmpSIOVREF__Dis_B_net;

	cy_psoc3_pins_v1_10
		#(.id("a9a81f18-a35b-496f-8762-4a1a84fb232e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Dis_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_C_net;
	wire [0:0] tmpFB_0__Dis_C_net;
	wire [0:0] tmpIO_0__Dis_C_net;
	wire [0:0] tmpINTERRUPT_0__Dis_C_net;
	electrical [0:0] tmpSIOVREF__Dis_C_net;

	cy_psoc3_pins_v1_10
		#(.id("3d313123-38cf-4bd6-a990-7777295476a3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Dis_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_D_net;
	wire [0:0] tmpFB_0__Dis_D_net;
	wire [0:0] tmpIO_0__Dis_D_net;
	wire [0:0] tmpINTERRUPT_0__Dis_D_net;
	electrical [0:0] tmpSIOVREF__Dis_D_net;

	cy_psoc3_pins_v1_10
		#(.id("49799f58-a16d-4366-9151-808ddac1bcb3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Dis_D_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_E_net;
	wire [0:0] tmpFB_0__Dis_E_net;
	wire [0:0] tmpIO_0__Dis_E_net;
	wire [0:0] tmpINTERRUPT_0__Dis_E_net;
	electrical [0:0] tmpSIOVREF__Dis_E_net;

	cy_psoc3_pins_v1_10
		#(.id("36f78a6c-c05c-48e2-a677-db0aa040277c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Dis_E_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_F_net;
	wire [0:0] tmpFB_0__Dis_F_net;
	wire [0:0] tmpIO_0__Dis_F_net;
	wire [0:0] tmpINTERRUPT_0__Dis_F_net;
	electrical [0:0] tmpSIOVREF__Dis_F_net;

	cy_psoc3_pins_v1_10
		#(.id("91f70284-2c5f-4457-ae58-d0a265a3c10d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Dis_F_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_G_net;
	wire [0:0] tmpFB_0__Dis_G_net;
	wire [0:0] tmpIO_0__Dis_G_net;
	wire [0:0] tmpINTERRUPT_0__Dis_G_net;
	electrical [0:0] tmpSIOVREF__Dis_G_net;

	cy_psoc3_pins_v1_10
		#(.id("6c961e0e-e6b8-4b3a-8680-e9ba87b1b0c3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Dis_G_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_DP_net;
	wire [0:0] tmpFB_0__Dis_DP_net;
	wire [0:0] tmpIO_0__Dis_DP_net;
	wire [0:0] tmpINTERRUPT_0__Dis_DP_net;
	electrical [0:0] tmpSIOVREF__Dis_DP_net;

	cy_psoc3_pins_v1_10
		#(.id("ef19cf32-bcb7-4972-99c5-7379ca7f3265"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dis_DP
		 (.oe(tmpOE__Dis_DP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dis_DP_net[0:0]}),
	...
	assign tmpOE__Dis_DP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_D1_net;
	wire [0:0] tmpFB_0__Dis_D1_net;
	wire [0:0] tmpIO_0__Dis_D1_net;
	wire [0:0] tmpINTERRUPT_0__Dis_D1_net;
	electrical [0:0] tmpSIOVREF__Dis_D1_net;

	cy_psoc3_pins_v1_10
		#(.id("8f2d9a34-dfc8-4ea7-8d13-311767a0c3e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dis_D1
		 (.oe(tmpOE__Dis_D1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dis_D1_net[0:0]}),
	...
	assign tmpOE__Dis_D1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_D2_net;
	wire [0:0] tmpFB_0__Dis_D2_net;
	wire [0:0] tmpIO_0__Dis_D2_net;
	wire [0:0] tmpINTERRUPT_0__Dis_D2_net;
	electrical [0:0] tmpSIOVREF__Dis_D2_net;

	cy_psoc3_pins_v1_10
		#(.id("ff1e1475-d49d-4f57-9d05-bf2fc29e892f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dis_D2
		 (.oe(tmpOE__Dis_D2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dis_D2_net[0:0]}),
	...
	assign tmpOE__Dis_D2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_D3_net;
	wire [0:0] tmpFB_0__Dis_D3_net;
	wire [0:0] tmpIO_0__Dis_D3_net;
	wire [0:0] tmpINTERRUPT_0__Dis_D3_net;
	electrical [0:0] tmpSIOVREF__Dis_D3_net;

	cy_psoc3_pins_v1_10
		#(.id("3c8f51f8-f882-4ead-8a66-595df5cdd117"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dis_D3
		 (.oe(tmpOE__Dis_D3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dis_D3_net[0:0]}),
	...
	assign tmpOE__Dis_D3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dis_D4_net;
	wire [0:0] tmpFB_0__Dis_D4_net;
	wire [0:0] tmpIO_0__Dis_D4_net;
	wire [0:0] tmpINTERRUPT_0__Dis_D4_net;
	electrical [0:0] tmpSIOVREF__Dis_D4_net;

	cy_psoc3_pins_v1_10
		#(.id("a2b83267-2aed-4528-952e-001c2cf359af"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dis_D4
		 (.oe(tmpOE__Dis_D4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dis_D4_net[0:0]}),
	...
	wire [0:0] tmpIO_0__OP_Out_net;
	wire [0:0] tmpINTERRUPT_0__OP_Out_net;
	electrical [0:0] tmpSIOVREF__OP_Out_net;

	cy_psoc3_pins_v1_10
		#(.id("f446bebb-9fa5-4c86-80c7-999d39ca74ef"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OP_Out
		 (.oe(tmpOE__OP_Out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OP_Out_net[0:0]}),
		  .analog({Net_11}),
		  .io({tmpIO_0__OP_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__OP_Out_net),
		  .interrupt({tmpINTERRUPT_0__OP_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OP_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Button_S4_Right_net;
	wire [0:0] tmpIO_0__Button_S4_Right_net;
	wire [0:0] tmpINTERRUPT_0__Button_S4_Right_net;
	electrical [0:0] tmpSIOVREF__Button_S4_Right_net;
	...
	assign tmpOE__Button_S4_Right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Button_S5_Select_net;
	wire [0:0] tmpIO_0__Button_S5_Select_net;
	wire [0:0] tmpINTERRUPT_0__Button_S5_Select_net;
	electrical [0:0] tmpSIOVREF__Button_S5_Select_net;

	cy_psoc3_pins_v1_10
		#(.id("038dfc81-8bc0-4177-83fe-8a86d74bf355"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Button_S5_Select_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Button_S2_Left_net;
	wire [0:0] tmpIO_0__Button_S2_Left_net;
	wire [0:0] tmpINTERRUPT_0__Button_S2_Left_net;
	electrical [0:0] tmpSIOVREF__Button_S2_Left_net;

	cy_psoc3_pins_v1_10
		#(.id("a83e0af3-2241-4bc6-8f14-6f7f499b44e8"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Button_S2_Left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Button_S1_Bottom_net;
	wire [0:0] tmpIO_0__Button_S1_Bottom_net;
	wire [0:0] tmpINTERRUPT_0__Button_S1_Bottom_net;
	electrical [0:0] tmpSIOVREF__Button_S1_Bottom_net;

	cy_psoc3_pins_v1_10
		#(.id("a3c4a0e7-1976-4177-b4bf-07b512b2e759"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Button_S1_Bottom_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Button_S3_Top_net;
	wire [0:0] tmpIO_0__Button_S3_Top_net;
	wire [0:0] tmpINTERRUPT_0__Button_S3_Top_net;
	electrical [0:0] tmpSIOVREF__Button_S3_Top_net;

	cy_psoc3_pins_v1_10
		#(.id("653b6b4a-8edf-43e7-9fb9-2e90212d54d4"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Button_S3_Top_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED2_Yellow_net;
	wire [0:0] tmpFB_0__LED2_Yellow_net;
	wire [0:0] tmpIO_0__LED2_Yellow_net;
	wire [0:0] tmpINTERRUPT_0__LED2_Yellow_net;
	electrical [0:0] tmpSIOVREF__LED2_Yellow_net;
	...
	cy_psoc3_pins_v1_10
		...
		LED2_Yellow
		 (.oe(tmpOE__LED2_Yellow_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__LED2_Yellow_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED2_Yellow_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam VDAC8_1.Initial_Value = 187;
    defparam VDAC8_1.Strobe_Mode = 0;

	wire [0:0] tmpOE__OP_Out_1_net;
	wire [0:0] tmpFB_0__OP_Out_1_net;
	wire [0:0] tmpIO_0__OP_Out_1_net;
	wire [0:0] tmpINTERRUPT_0__OP_Out_1_net;
	electrical [0:0] tmpSIOVREF__OP_Out_1_net;

	cy_psoc3_pins_v1_10
		#(.id("d492611a-d288-47f3-acc3-5e0956c2af71"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OP_Out_1
		 (.oe(tmpOE__OP_Out_1_net),
		  .y({Net_138}),
		  .fb({tmpFB_0__OP_Out_1_net[0:0]}),
		  .io({tmpIO_0__OP_Out_1_net[0:0]}),
		  .siovref(tmpSIOVREF__OP_Out_1_net),
		  .interrupt({tmpINTERRUPT_0__OP_Out_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	cy_clock_v1_0
		#(.id("2ee17c5c-0957-4874-a029-96b45a077c11"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__TX2_Ultra_net;
	wire [0:0] tmpFB_0__TX2_Ultra_net;
	wire [0:0] tmpIO_0__TX2_Ultra_net;
	wire [0:0] tmpINTERRUPT_0__TX2_Ultra_net;
	electrical [0:0] tmpSIOVREF__TX2_Ultra_net;

	cy_psoc3_pins_v1_10
		#(.id("3bfa6f85-c5ee-4417-bf31-1ba39b9cdd53"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TX2_Ultra
		 (.oe(tmpOE__TX2_Ultra_net),
		  .y({Net_205}),
		  .fb({tmpFB_0__TX2_Ultra_net[0:0]}),
		  .io({tmpIO_0__TX2_Ultra_net[0:0]}),
		  .siovref(tmpSIOVREF__TX2_Ultra_net),
		  .interrupt({tmpINTERRUPT_0__TX2_Ultra_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TX2_Ultra_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TX1_Ultra_net;
	wire [0:0] tmpFB_0__TX1_Ultra_net;
	wire [0:0] tmpIO_0__TX1_Ultra_net;
	wire [0:0] tmpINTERRUPT_0__TX1_Ultra_net;
	electrical [0:0] tmpSIOVREF__TX1_Ultra_net;

	cy_psoc3_pins_v1_10
		#(.id("2850f2d4-719d-428f-bd5c-690fdc5bf17b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TX1_Ultra
		 (.oe(tmpOE__TX1_Ultra_net),
		  .y({Net_474}),
		  .fb({tmpFB_0__TX1_Ultra_net[0:0]}),
		  .io({tmpIO_0__TX1_Ultra_net[0:0]}),
		  .siovref(tmpSIOVREF__TX1_Ultra_net),
		  .interrupt({tmpINTERRUPT_0__TX1_Ultra_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpOE__Rec1_net;
	wire [0:0] tmpFB_0__Rec1_net;
	wire [0:0] tmpIO_0__Rec1_net;
	wire [0:0] tmpINTERRUPT_0__Rec1_net;
	electrical [0:0] tmpSIOVREF__Rec1_net;

	cy_psoc3_pins_v1_10
		#(.id("bd0bda36-bb86-4b8e-bd83-7f621d565a41"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Rec1
		 (.oe(tmpOE__Rec1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Rec1_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__Rec1_net[0:0]}),
		  .siovref(tmpSIOVREF__Rec1_net),
		  .interrupt({tmpINTERRUPT_0__Rec1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rec1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Rec2_net;
	wire [0:0] tmpFB_0__Rec2_net;
	wire [0:0] tmpIO_0__Rec2_net;
	wire [0:0] tmpINTERRUPT_0__Rec2_net;
	electrical [0:0] tmpSIOVREF__Rec2_net;
	...
	cy_psoc3_pins_v1_10
		...
		Rec2
		 (.oe(tmpOE__Rec2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Rec2_net[0:0]}),
		  .analog({Net_372}),
		  .io({tmpIO_0__Rec2_net[0:0]}),
		  .siovref(tmpSIOVREF__Rec2_net),
		  .interrupt({tmpINTERRUPT_0__Rec2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rec2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("8fe6a0ac-997d-4f67-8372-19745c555dc4"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("25000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5abbe5e6-fbb8-4564-ae08-8a137c990e09"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpIO_0__Button_S1_Bottom_State_net;
	wire [0:0] tmpINTERRUPT_0__Button_S1_Bottom_State_net;
	electrical [0:0] tmpSIOVREF__Button_S1_Bottom_State_net;

	cy_psoc3_pins_v1_10
		#(.id("48dabdce-7bfd-478a-8a68-0f91edb036cc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Button_S1_Bottom_State
		 (.oe(tmpOE__Button_S1_Bottom_State_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Button_S1_Bottom_State_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_S1_Bottom_State_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Button_S2_Left_State_net;
	wire [0:0] tmpFB_0__Button_S2_Left_State_net;
	wire [0:0] tmpIO_0__Button_S2_Left_State_net;
	wire [0:0] tmpINTERRUPT_0__Button_S2_Left_State_net;
	electrical [0:0] tmpSIOVREF__Button_S2_Left_State_net;

	cy_psoc3_pins_v1_10
		#(.id("23cfbf88-3e69-49b2-a4c6-9de2ef65ad53"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Button_S2_Left_State
		 (.oe(tmpOE__Button_S2_Left_State_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Button_S2_Left_State_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_S2_Left_State_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Button_S3_Top_State_net;
	wire [0:0] tmpFB_0__Button_S3_Top_State_net;
	wire [0:0] tmpIO_0__Button_S3_Top_State_net;
	wire [0:0] tmpINTERRUPT_0__Button_S3_Top_State_net;
	electrical [0:0] tmpSIOVREF__Button_S3_Top_State_net;

	cy_psoc3_pins_v1_10
		#(.id("9b4d6a0c-5f57-4392-be9d-5e9eb4da93ef"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Button_S3_Top_State
		 (.oe(tmpOE__Button_S3_Top_State_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Button_S3_Top_State_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_S3_Top_State_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Button_S4_Right_State_net;
	wire [0:0] tmpFB_0__Button_S4_Right_State_net;
	wire [0:0] tmpIO_0__Button_S4_Right_State_net;
	wire [0:0] tmpINTERRUPT_0__Button_S4_Right_State_net;
	electrical [0:0] tmpSIOVREF__Button_S4_Right_State_net;

	cy_psoc3_pins_v1_10
		#(.id("19ba1190-0de0-4da9-accf-25e993acc0dc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Button_S4_Right_State
		 (.oe(tmpOE__Button_S4_Right_State_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Button_S4_Right_State_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_S4_Right_State_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Button_S5_Select_State_net;
	wire [0:0] tmpFB_0__Button_S5_Select_State_net;
	wire [0:0] tmpIO_0__Button_S5_Select_State_net;
	wire [0:0] tmpINTERRUPT_0__Button_S5_Select_State_net;
	electrical [0:0] tmpSIOVREF__Button_S5_Select_State_net;

	cy_psoc3_pins_v1_10
		#(.id("cc959838-99c2-47ff-b5c8-c5892a9eae41"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Button_S5_Select_State
		 (.oe(tmpOE__Button_S5_Select_State_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Button_S5_Select_State_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
